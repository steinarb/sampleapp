...
Then open http://localhost:8181/sampleapp in a web browser.
...
To create a new project called "mynewapp":
 ...
 3. Fix up some files that aren't handled by the archetype filtering (don't know why everything in the pom files aren't filtered)
    ...
    #+end_example
 4. Add a .gitignore file (there is a bug in maven-resources-plugin that excludes this file from archetypes):
    #+begin_example
      ,*.iml
      ,*.log
      .classpath
