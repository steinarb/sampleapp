...
To create a new project called "mynewapp":
 ...
 11. Fix copyright dates
     #+begin_example
       find . -name pom.xml | xargs sed -i 's/2021-2022/2024/g'
       find . -name feature.xml | xargs sed -i 's/2021-2022/2024/g'
       find . -name *.java | xargs sed -i 's/2021-2022/2024/g'
       find . -name pom.xml | xargs sed -i 's/2021-2023/2024/g'
       find . -name feature.xml | xargs sed -i 's/2021-2023/2024/g'
       find . -name *.java | xargs sed -i 's/2021-2023/2024/g'
       find . -name pom.xml | xargs sed -i 's/2021/2024/g'
       find . -name feature.xml | xargs sed -i 's/2021/2024/g'
