...
public class SampleappException extends RuntimeException {
     ...
     * {@inheritDoc}
     */
    public SampleappException(Throwable e) {
        super(e);
    }
     ...
     * {@inheritDoc}
     */
    public SampleappException(String message, Throwable e) {
        super(message, e);
    }
     ...
     * {@inheritDoc}
     */
    public SampleappException(String message, Throwable e, boolean enableSuppression, boolean writableStackTrace) {
